/*
 ...
 Source Schema         : university_personnel_management

 Target Server Type    : MySQL
 Target Server Version : 80037
 File Encoding         : 65001

 Date: 14/06/2025 17:38:18
*/
...
-- ----------------------------
INSERT INTO `task_orders` VALUES (1, 1, 2, '完成计算机教学团队的教学计划制定', 'high', '2024-01-01', 'pending', '2025-06-14 17:31:15', '2025-06-14 17:31:15');
INSERT INTO `task_orders` VALUES (2, 2, 3, '开展学生管理团队的学生心理调研', 'medium', '2024-02-01', 'pending', '2025-06-14 17:31:15', '2025-06-14 17:31:15');
INSERT INTO `task_orders` VALUES (3, 3, 4, '推进物理科研团队的科研项目进度', 'high', '2024-03-01', 'pending', '2025-06-14 17:31:15', '2025-06-14 17:31:15');
INSERT INTO `task_orders` VALUES (4, 4, 5, '制定系级管理团队的年度工作计划', 'high', '2024-04-01', 'pending', '2025-06-14 17:31:15', '2025-06-14 17:31:15');
INSERT INTO `task_orders` VALUES (5, 5, 6, '优化综合教学团队的教学资源配置', 'medium', '2024-05-01', 'pending', '2025-06-14 17:31:15', '2025-06-14 17:31:15');
INSERT INTO `task_orders` VALUES (6, 6, 7, '组织学生辅助团队的培训活动', 'high', '2024-06-01', 'pending', '2025-06-14 17:31:15', '2025-06-14 17:31:15');
INSERT INTO `task_orders` VALUES (7, 7, 8, '完善历史教学科研团队的科研成果整理', 'medium', '2024-07-01', 'pending', '2025-06-14 17:31:15', '2025-06-14 17:31:15');
INSERT INTO `task_orders` VALUES (8, 8, 9, '提升行政服务团队的服务质量', 'high', '2024-08-01', 'pending', '2025-06-14 17:31:15', '2025-06-14 17:31:15');
INSERT INTO `task_orders` VALUES (9, 9, 10, '改进英语教学团队的教学方法', 'high', '2024-09-01', 'pending', '2025-06-14 17:31:15', '2025-06-14 17:31:15');
INSERT INTO `task_orders` VALUES (10, 10, 1, '加强辅导员团队的学生管理工作', 'medium', '2024-10-01', 'pending', '2025-06-14 17:31:15', '2025-06-14 17:31:15');
...
CREATE TABLE `users`  (
  ...
  `role` enum('super_admin','campus_leader','personnel_specialist','department_head','cadre') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `create_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `update_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE,
